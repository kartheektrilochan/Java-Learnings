...
public class WithThreadCapabilityTest implements Runnable{
	...
	public static void main(String[] args) {
		...
		WithThreadCapabilityTest clsObj=new WithThreadCapabilityTest();
		...
		System.out.println("Time Taken with thread2 loop:"+utility.timeTakenforExecute(stopTime, startTime));
